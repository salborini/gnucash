...
void qof_query_object_register (GNCIdTypeConst obj_name,
			     QofQuerySort default_sort_function,
...
QofQueryAccess qof_query_object_get_parameter_getter (GNCIdTypeConst obj_name,
					      const char *parameter)
{
...
QofQuerySort gncQofQueryObjectaultSort (GNCIdTypeConst obj_name)
{
